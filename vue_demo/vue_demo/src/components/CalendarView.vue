	...
	<div class="calendar-view">
		<div class="calendar-toolbar">
			...
			<div class="calendar-nav">
				<el-input v-model="input" style="width: 240px" placeholder="搜索任务" clearable />
		...
		<FullCalendar ref="calendarRef" :options="calendarOptions" :key="tasks.length" class="full-calendar" />

		<!-- 统一任务详情弹窗 -->
		<TaskDetailDialog :visible="taskDialogVisible" :task="selectedTask"
